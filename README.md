...
- `docs/prototype-lifter.md` — the lift from certified artefacts to a trackerprog: the schedule derived (B6), the tick lowered and T1's accumulators joined (B7), the coverage, the certificate, the field-by-field diff against the hand object, and the limits the pass does not change.
