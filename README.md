...
- `docs/tuneprog-plan.md` — plan v2 after the first prototyping round: lessons, backlog, the fold/stack gate with the stack-elimination work spec, next prototypes, Ghidra/SMC leverage assessment.
