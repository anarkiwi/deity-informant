...
| J12 | structuring | **0** `sp`, 0 `trap 'unverified'`, 25 `trap 'untaken'`, **0** `goto` in 624 printed lines (613 before Q1b's two record headers, 7 `goto` in 562 before Q1a) | 0 `sp`, 0 unverified, 16 untaken, **0** `goto` in 580 lines (569, and 7 in 528) |
