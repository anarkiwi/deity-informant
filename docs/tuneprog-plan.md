...
| code | `deity_informant/tuneprog/`, 54 modules, 15,771 lines, none over 500 (`pipeline.py` 510 excepted); 624 hermetic + 60 HVSC + 10 oracle tests, 95 % coverage; `tools/tuneprog_certify.py`, `tools/tuneprog_recert.py` (50/50 reproduce), `tools/tuneprog_period.py`, `tools/tuneprog_ghidra.py` |
