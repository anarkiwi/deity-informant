...
| code | `deity_informant/tuneprog/`, 49 modules, 14,377 lines, none over 500 (`pipeline.py` 506 excepted); 567 hermetic + 52 HVSC tests, 96 % coverage; `tools/tuneprog_certify.py`, `tools/tuneprog_recert.py` (46/46 reproduce), `tools/tuneprog_period.py`, `tools/tuneprog_ghidra.py` |
