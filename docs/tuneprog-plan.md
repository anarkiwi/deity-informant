...
| code | `deity_informant/tuneprog/`, 45 modules, 13,483 lines, none over 510; 499 hermetic + 43 HVSC + 4 oracle tests, 95 % coverage; `tools/tuneprog_certify.py`, `tools/tuneprog_recert.py` (44/44 reproduce), `tools/tuneprog_period.py`, `tools/tuneprog_ghidra.py` |
...
data-gated on the sweep. P1, P2, P-JCH and Q1a are done; the campaign is also
