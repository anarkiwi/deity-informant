...
| code | `deity_informant/tuneprog/`, 52 modules, 15,276 lines, none over 500 (`pipeline.py` 510 excepted); 608 hermetic + 60 HVSC + 10 oracle tests, 96 % coverage; `tools/tuneprog_certify.py`, `tools/tuneprog_recert.py` (50/50 reproduce), `tools/tuneprog_period.py`, `tools/tuneprog_ghidra.py` |
