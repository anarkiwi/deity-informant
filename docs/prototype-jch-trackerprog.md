...
The form is one target: a register named outright in a `sets` list is that
register of the global channel, appended to the voice's producer list and emitted where the voice
