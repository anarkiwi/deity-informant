...
refuses as a `sample stream`. Seven of eight prints are below the source's
`xz` (Hubbard's per-row SID writes keep his above). The sound half is still
